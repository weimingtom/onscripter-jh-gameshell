...
#if (defined(IOS) || defined(ANDROID) || defined(WINRT) || defined(MIYOO))
...
#if 0 //defined(MIYOO)
    window = SDL_CreateWindow(NULL, window_x, window_y, 320, 240, window_flag);
#else
...
#if defined(MIYOO)
    SDL_RenderSetLogicalSize(renderer, 320, 240); //Auto scale center
#else
...
void ONScripter::flushDirect( SDL_Rect &rect, int refresh_mode )
{
    ...
    #if defined(ANDROID) || defined(_MSC_VER) || defined(__APPLE__) || defined(MIYOO)
